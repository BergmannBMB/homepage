export default async function handler(req, res) {
  ...
  try {
              ...
              const { vorname, nachname, email, telefon, unternehmen, position, branche, groesse, nachricht, newsletter, notify_check } = body;
              ...
              const newsletterText = newsletter === 'ja' ? 'Ja' : 'Nein';
                const notifyText = notify_check === 'ja' ? 'Ja' : 'Nein';
              ...
              const notifyPayload = {
                              ...
                              htmlContent: '<div style="font-family: sans-serif; padding: 20px;"><h2 style="color: #1a3b55;">Neuer Whitepaper-Download</h2><p><b>Name:</b> ' + vorname + ' ' + nachname + '</p><p><b>E-Mail:</b> ' + email + '</p><p><b>Telefon:</b> ' + (telefon || '-') + '</p><p><b>Unternehmen:</b> ' + unternehmen + '</p><p><b>Position:</b> ' + (position || '-') + '</p><p><b>Branche:</b> ' + (branche || '-') + '</p><p><b>Groesse:</b> ' + (groesse || '-') + '</p><p><b>Herausforderung:</b> ' + (nachricht || '-') + '</p><hr style="margin: 16px 0;"><p><b>Newsletter:</b> ' + newsletterText + '</p><p><b>HumanFit Check Benachrichtigung:</b> ' + notifyText + '</p></div>'
              };
